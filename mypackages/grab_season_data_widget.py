...
class Ui_WidgetGrabSeasonData(object):
    ...
    def retranslateUi(self, WidgetGrabSeasonData):
        ...
        self.labelGrabUnsigned.setText(QCoreApplication.translate("WidgetGrabSeasonData", u"Grab Unsiigned Recruits", None))
        self.labelCheckMarkGrabUnsigned.setText("")
        self.labelGrabSigned.setText(QCoreApplication.translate("WidgetGrabSeasonData", u"Grab Siigned Recruits", None))
