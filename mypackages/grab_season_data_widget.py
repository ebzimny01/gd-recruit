...
class Ui_WidgetGrabSeasonData(object):
    def setupUi(self, WidgetGrabSeasonData):
        ...
        WidgetGrabSeasonData.resize(530, 540)
        ...
        WidgetGrabSeasonData.setMinimumSize(QSize(530, 540))
        WidgetGrabSeasonData.setMaximumSize(QSize(530, 540))
        font = QFont()
        ...
        self.pushButtonMarkRecruitsFromWatchlist.setFont(font1)

        self.gridLayout.addWidget(self.pushButtonMarkRecruitsFromWatchlist, 19, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelCheckMarkCreateDB, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelCheckMarkGrabUnsigned, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelCheckMarkAuthWIS_MarkRecruits, 20, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.progressBarInitializeRecruits, 9, 3, 1, 1)
        ...
        self.labelGrabUnsigned.setFont(font2)

        self.gridLayout.addWidget(self.labelGrabUnsigned, 6, 3, 1, 1)
        ...
        self.labelProgressCreateRecruitDB.setFont(font2)

        self.gridLayout.addWidget(self.labelProgressCreateRecruitDB, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.progressBarUpdateConsidering, 15, 3, 1, 1)
        ...
        self.pushButtonInitializeRecruits.setFont(font1)
        ...
        self.pushButtonUpdateConsideringSigned.setFont(font1)

        self.gridLayout.addWidget(self.pushButtonUpdateConsideringSigned, 13, 3, 1, 1)
        ...
        self.labelGrabStaticData.setFont(font2)

        self.gridLayout.addWidget(self.labelGrabStaticData, 8, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelCheckMarkAuthWIS_Error, 4, 1, 1, 1)
        ...
        self.gridLayout.addItem(self.verticalSpacer_2, 16, 3, 1, 1)

        self.verticalSpacer_3 = QSpacerItem(20, 10, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout.addItem(self.verticalSpacer_3, 12, 3, 1, 1)
        ...
        self.labelUpdateStatusText.setFont(font2)

        self.gridLayout.addWidget(self.labelUpdateStatusText, 14, 3, 1, 1)

        self.verticalSpacer = QSpacerItem(20, 10, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout.addItem(self.verticalSpacer, 10, 3, 1, 1)
        ...
        self.labelAuthWIS_MarkRecruits.setFont(font2)

        self.gridLayout.addWidget(self.labelAuthWIS_MarkRecruits, 20, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelCheckMarkAuthWIS_Error_MarkRecruits, 20, 1, 1, 1)
        ...
        self.labelAuthWIS.setFont(font2)

        self.gridLayout.addWidget(self.labelAuthWIS, 4, 3, 1, 1)
        ...
        self.labelGrabSigned.setFont(font2)

        self.gridLayout.addWidget(self.labelGrabSigned, 7, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelCheckMarkGrabSigned, 7, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.progressBarMarkWatchlist, 21, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelCheckMarkAuthWIS, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelCheckMarkGrabStaticData, 8, 2, 1, 1)

        self.verticalSpacer_4 = QSpacerItem(20, 10, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout.addItem(self.verticalSpacer_4, 18, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelCheckmarkUpdateConsidering, 14, 2, 1, 1)
        ...
        self.gridLayout.addItem(self.verticalSpacer_6, 2, 0, 1, 1)
